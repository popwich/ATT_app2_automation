...
package Pages.ATT_LikeDislikePage_subpages.ATT_LikesSubPage_subpages;
...
/**
 * subpage after click remind me later
 * @param <wait_timeout>
 */
public class ATT_remindsubpage<wait_timeout> extends BasePage{
    /*@AndroidFindBy(name = "Rate")
    private WebElement rateButton;  */      
        
    public ATT_remindsubpage(AppiumDriver driver) {
        super(driver);
    }
