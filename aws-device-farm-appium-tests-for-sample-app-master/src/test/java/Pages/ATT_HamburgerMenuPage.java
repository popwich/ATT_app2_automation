...
public class ATT_HamburgerMenuPage extends BasePage{
    ...
    ****************************************************/
    public Boolean isArmed() {
        return (alarm_tab.getText().equals("ARMED: "));  //there is a space behind ARMED
    }
    ...
    ****************************************************/
    ...
    public Boolean isCurrentPage() {
     	try {
     		 return (menuMyaccount.isDisplayed() & menuSignout.isDisplayed()); //return true if both home and devices menu are displayed
    	}
    	catch (Exception e){
         	e.getMessage();
